...
latex_documents = [
    (master_doc, 'PhaserEditor.tex', u'Phaser Editor Documentation',
...
man_pages = [
    (master_doc, 'phasereditor', u'Phaser Editor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PhaserEditor', u'Phaser Editor Documentation',
     author, 'PhaserEditor', 'One line description of project.',
     'Miscellaneous'),
]
