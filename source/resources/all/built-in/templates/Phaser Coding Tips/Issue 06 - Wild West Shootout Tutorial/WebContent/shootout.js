...
Shootout.Boot.prototype = {
	...
	preload : function() {
		...
		// this.load.baseURL =
		// 'http://files.phaser.io.s3.amazonaws.com/codingtips/issue006/';
...
Shootout.Game.prototype = {
	...
	create : function() {
		...
		this.helpText = this.add.bitmapText(630, 404, 'font',
	...
	startDraw : function() {
		...
		var reactionTime = this.rnd.between(this.reactionTimeMin,
