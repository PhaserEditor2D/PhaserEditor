...
GameState.prototype.create = function() {
    ...
    this.tweenFunctions = [
        { name: "Sinusoidal In", ease: Phaser.Easing.Sinusoidal.In },
        { name: "Sinusoidal Out", ease: Phaser.Easing.Sinusoidal.Out },
        { name: "Sinusoidal InOut", ease: Phaser.Easing.Sinusoidal.InOut }
    ];
