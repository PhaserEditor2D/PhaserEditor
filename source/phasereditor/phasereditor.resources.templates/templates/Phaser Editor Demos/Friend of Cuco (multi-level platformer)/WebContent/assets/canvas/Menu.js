...
Menu.prototype.create = function () {
	...
	var _dino = this.add.sprite(58, 347, 'dino', 0);
	var _dino_idle = _dino.animations.add('idle', [0, 1, 2], 4, true);
	_dino_idle.play();
	
	var _frutapan = this.add.sprite(110, 405, 'frutapan');
...
Menu.prototype.initObjects = function() {
	...
	this.add.tween(this.fFrutapan).to({
		y : this.fFrutapan.y + 1
	}, 200, "Linear", true, 0, Number.MAX_VALUE, true);
};
