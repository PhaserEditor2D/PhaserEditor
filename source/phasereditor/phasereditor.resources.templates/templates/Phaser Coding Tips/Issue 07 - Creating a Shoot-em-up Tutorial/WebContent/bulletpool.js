...
Weapon.FrontAndBack = function(game) {
	...
	Phaser.Group.call(this, game, game.world, 'Front And Back', false, true,
			Phaser.Physics.ARCADE);
...
Weapon.ThreeWay = function(game) {
	...
	Phaser.Group.call(this, game, game.world, 'Three Way', false, true,
			Phaser.Physics.ARCADE);
...
Weapon.EightWay = function(game) {
	...
	Phaser.Group.call(this, game, game.world, 'Eight Way', false, true,
			Phaser.Physics.ARCADE);
...
Weapon.ScatterShot = function(game) {
	...
	Phaser.Group.call(this, game, game.world, 'Scatter Shot', false, true,
			Phaser.Physics.ARCADE);
...
Weapon.Beam = function(game) {
	...
	Phaser.Group.call(this, game, game.world, 'Beam', false, true,
			Phaser.Physics.ARCADE);
...
Weapon.SplitShot = function(game) {
	...
	Phaser.Group.call(this, game, game.world, 'Split Shot', false, true,
			Phaser.Physics.ARCADE);
...
Weapon.Pattern = function(game) {
	...
	Phaser.Group.call(this, game, game.world, 'Pattern', false, true,
			Phaser.Physics.ARCADE);
	...
	this.pattern = this.pattern.concat(Phaser.ArrayUtils.numberArrayStep(800,
			-800, -200));
...
PhaserGame.prototype = {
	...
	create : function() {
		...
		this.weaponName = this.add.bitmapText(8, 364, 'shmupfont',
				"ENTER = Next Weapon", 24);
