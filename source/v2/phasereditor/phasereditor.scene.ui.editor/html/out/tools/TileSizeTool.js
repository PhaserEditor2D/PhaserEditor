    ...
    var TileSizeTool = (function (_super) {
        ...
        TileSizeTool.prototype.render = function (list) {
            ...
            for (var _i = 0, list_1 = list; _i < list_1.length; _i++) {
                ...
                var localLeft = -width * sprite.originX;
                var localTop = -height * sprite.originY;
                var worldXY = new Phaser.Math.Vector2();
                var worldTx = sprite.getWorldTransformMatrix();
                var localX = this._changeX ? localLeft + width : localLeft + width / 2;
                var localY = this._changeY ? localTop + height : localTop + height / 2;
