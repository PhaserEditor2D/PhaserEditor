...
(function (PhaserEditor2D) {
    var AngleTool = (function (_super) {
        ...
        function AngleTool() {
            ...
            _this._handlerShapeBorder = _this.createEllipseShape();
            _this._handlerShapeBorder.setFillStyle(0, 0);
            _this._handlerShapeBorder.setStrokeStyle(4, 0);
            _this._handlerShapeBorder.setSize(AngleTool.RADIUS * 2, AngleTool.RADIUS * 2);
            _this._handlerShape = _this.createEllipseShape();
            _this._handlerShape.setFillStyle(0, 0);
            _this._handlerShape.setStrokeStyle(2, _this._color);
            _this._handlerShape.setSize(AngleTool.RADIUS * 2, AngleTool.RADIUS * 2);
